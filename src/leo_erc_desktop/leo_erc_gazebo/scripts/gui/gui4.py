...
class Ui_Navigation_Task(object):
    ...
    def decide(self):
        ...
        self.nav_goal.target_pose.header.frame_id = "odom"
        self.nav_goal.target_pose.header.stamp = rospy.Time.now()
        self.nav_goal.target_pose.pose.position.x = self.goals[self.goalno][0]
        self.nav_goal.target_pose.pose.position.y = self.goals[self.goalno][1]
        self.nav_goal.target_pose.pose.position.z = self.goals[self.goalno][2]
        self.nav_goal.target_pose.pose.orientation.x = self.goals[self.goalno][3]
        self.nav_goal.target_pose.pose.orientation.y = self.goals[self.goalno][4]
        self.nav_goal.target_pose.pose.orientation.z = self.goals[self.goalno][5]
        self.nav_goal.target_pose.pose.orientation.w = self.goals[self.goalno][6]
        print(self.nav_goal)
